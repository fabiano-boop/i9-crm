...
const dailyLeadScraper_job_js_1 = require("./jobs/dailyLeadScraper.job.js");
...
httpServer.listen(PORT, () => {
    ...
    try {
        (0, dailyLeadScraper_job_js_1.startDailyLeadScraperJob)();
        logger_js_1.logger.info('Scraper diário de leads iniciado com sucesso');
    }
    catch (err) {
        logger_js_1.logger.error({ err }, 'Falha ao iniciar scraper de leads');
    }
});
