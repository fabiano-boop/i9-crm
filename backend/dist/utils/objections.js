...
exports.OBJECTION_LIBRARY = void 0;
exports.detectObjection = detectObjection;
exports.getObjectionContext = getObjectionContext;
exports.requiresImmediateEscalation = requiresImmediateEscalation;
exports.OBJECTION_LIBRARY = [
    // ── Preço ──────────────────────────────────────────────────────────────────
    {
        key: 'preco_caro',
...
function detectObjection(message) {
    ...
    const sorted = [...exports.OBJECTION_LIBRARY].sort((a, b) => b.triggers.length - a.triggers.length);
...
function getObjectionContext(message) {
...
function requiresImmediateEscalation(message) {
    const obj = detectObjection(message);
    return obj?.escalate === true;
}
//# sourceMappingURL=objections.js.map