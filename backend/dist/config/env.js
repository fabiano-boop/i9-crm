...
const envSchema = zod_1.z.object({
    ...
    EVOLUTION_API_URL: zod_1.z.string().default('http://localhost:8080'),
    EVOLUTION_API_KEY: zod_1.z.string().default(''),
    EVOLUTION_INSTANCE_NAME: zod_1.z.string().default('i9crm'),
